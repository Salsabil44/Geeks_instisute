...
def ai_understand(cmd):
    ...
    try:
        ...
        if "intent" not in result or not result["intent"]:
            return {"intent": "fallback", "message": "Sorry, I'm not allowed to do this."}

        return result

    except (requests.exceptions.RequestException, json.JSONDecodeError):
        return {"intent": "fallback", "message": "Sorry, I'm not allwed to do this."}
...
""")
            ...
            print("🤖 AI HR Agent: Sorry, I can't do this.")
